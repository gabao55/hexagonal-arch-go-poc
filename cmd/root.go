...
import (
	...
	"database/sql"
	dbInfra "github.com/gabao55/hexagonal-arch-go/adapters/db"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.hexagonal-arch-go.yaml)")
